...
class ORMFixture:
    ...
    def get_contact_list(self):
        return self.convert_contacts_to_model(list(select(c for c in ORMFixture.ORMGroup if c.deprecated is None)))
    ...
    def get_contacts_not_in_group(self, group):
        ...
        return self.convert_contacts_to_model(
            select(c for c in ORMFixture.ORMGroup if c.deprecated is None and orm_group not in c.groups))